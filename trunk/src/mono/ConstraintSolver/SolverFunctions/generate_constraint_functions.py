"""This module parses the constraint equations in the file solver_functions.txt
and generates a class in C# for each constraint equation. The generated C# file is 
ConstraintFunctions.cs. The existing C# file is deleted. """
...
if __name__ == "__main__":
    ...
    source_template = Template(filename='SolverFunctions.cs.template')
    source_file = open('SolverFunctions.cs','w')
